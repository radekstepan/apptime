...
require.register("nathan7-memoize/index.js", function(exports, require, module){
...
module.exports = function() {
  return request.get('/api', function(res) {
    var data;
    if (res.statusType !== 2) {
      return document.body.innerHTML = res.text;
    }
    data = JSON.parse(res.text);
    document.body.innerHTML = template(_.extend(data, {
      toMinutes: _.memoize(function(seconds) {
...
require.register("app/template.js", function(exports, require, module){
module.exports = function(__obj) {
  ...
  (function() {
    (function() {
      var column, date, day, downtime, error, handler, history, latest, name, names, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4;
      ...
      if (this.errors) {
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          _ref2 = _ref1[_j], day = _ref2[0], date = _ref2[1];
          __out.push('\n                                <th>\n                                    <h3>');
          __out.push(__sanitize(day));
          __out.push('</h3>\n                                    <h4>');
          __out.push(__sanitize(date));
          __out.push('</h4>\n                                </th>\n                            ');
        }
        __out.push('\n                        </tr>\n                    </thead>\n                    <tbody>\n                        ');
        _ref3 = this.data;
        for (handler in _ref3) {
          names = _ref3[handler];
          __out.push('\n                            ');
          for (name in names) {
            _ref4 = names[name], latest = _ref4.latest, history = _ref4.history;
            __out.push('\n                                <tr>\n                                    <th>\n                                        ');
            if (latest.up) {
              __out.push('\n                                            <div class="tipped green circle" title="Up"></div>\n                                        ');
            } else {
              __out.push('\n                                            <div class="tipped red circle" title="Down"></div>\n                                        ');
            }
            __out.push('\n                                        <h2 class="tipped" title="');
            __out.push(__sanitize(handler));
            __out.push('">');
            __out.push(__sanitize(name));
            __out.push('</h2>\n                                    </th>\n                                    ');
            for (column in history) {
              downtime = history[column];
              __out.push('\n                                        <td class="column');
              ...
              if (downtime === 0) {
                ...
                __out.push('\n                                                <!-- more than 30m? -->\n                                                ');
                if (downtime < 1800) {
                  __out.push('\n                                                    <div class="tipped orange circle" title="Down for ');
                  __out.push(__sanitize(this.toMinutes(downtime)));
                  __out.push('"></div>\n                                                ');
                } else {
                  __out.push('\n                                                    <div class="tipped red circle" title="Down for ');
                  __out.push(__sanitize(this.toMinutes(downtime)));
                  __out.push('"></div>\n                                                ');
                }
                __out.push('\n                                            ');
...
require.alias("nathan7-memoize/index.js", "app/deps/memoize/index.js");
require.alias("nathan7-memoize/index.js", "memoize/index.js");
...
require.alias("gorillatron-extend/index.js", "app/deps/extend/index.js");
